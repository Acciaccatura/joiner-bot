...
module.exports = (slapp) => {
	...
	slapp.command('/channel', '(\\w*)', (msg, text, spec_channel) => {
		channels.siftBlacklist(slapp, msg.meta.bot_token, msg.meta.user_id, (err, isBlacklisted) => {
			...
			channels.siftChannels(slapp, msg.meta.bot_token, spec_channel, (err, data) => {
